...
function Sonnensystem.new ()  
  ...
  instance.sonne = Himmelskoerper.new("Sonne",      2.0*10^30,  1391000/2,  {0.0*10^6, 0, 0},    {0,0,0}, color.sunny_yellow)
  ...
  --instance.erde = Himmelskoerper.new("Erde",        6.0*10^24,  12756.28/2, {149.52660^6, 0, 0}, {0, 107208, 0}, color.cloudy_blue)
...
function Sonnensystem:tick()
  for name, himmelskoerper in pairs(self) do
    sx = himmelskoerper.geschwindigkeit[1]
    sy = himmelskoerper.geschwindigkeit[2]
    sz = himmelskoerper.geschwindigkeit[3]
