...
function Sonnensystem.new ()  
  ...
  instance.merkur = Himmelskoerper.new("Merkur",    3.3*10^23,  4878/2,     {58*10^6, 0, 0},     geschwindigkeit, color.sunny_yellow)
  ...
  instance.uranus = Himmelskoerper.new("Uranus",    8.7*10^25,  51118/2,    {2871*10^6, 0, 0},   geschwindigkeit, color.sunny_yellow)
  instance.neptun = Himmelskoerper.new("Neptun",    1.02*10^26, 49532/2,    {4498*10^6, 0, 0},   geschwindigkeit, color.sunny_yellow)
  instance.pluto = Himmelskoerper.new("Pluto",      1.3*10^22,  5906/2,     {5906*10^6, 0, 0}, geschwindigkeit, color.orangered)
