...
function Sonnensystem.new ()  
  ...
  instance.sonne = Himmelskoerper.new("Sonne",      2.0*10^30,  1391000/2,  {0*10^6, 0, 0},      geschwindigkeit)
  ...
  instance.erde = Himmelskoerper.new("Erde",        6.0*10^24,  12756.28/2, {150*10^6, 0, 0},    geschwindigkeit)
  instance.mond = Himmelskoerper.new("Mond",        7.35*10^22, 3473.8/2,   {149.52660^6, 0, 0}, geschwindigkeit)
  instance.mars = Himmelskoerper.new("Mars",        6.4*10^23,  6794/2,     {228*10^6, 0, 0},    geschwindigkeit)
